...
class GroupChatConsumer(AsyncWebsocketConsumer):
    async def connect(self):
        try:
            ...
            if not token:
                print("No token provided in connection")
                await self.close(code=4000)  # Custom code for no token
                return
            ...
            if not is_member:
                ...
                await self.close(code=4003)  # Custom code for no access
                return
            ...
            await self.close(code=4002)  # Custom code for other errors
    ...
    async def chat_message(self, event):
        # Send received group message to client
